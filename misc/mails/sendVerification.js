...
async function sendVerification (to,code,link,userID) {
    try {
        a = await   transporter.sendMail({
            ...
            html: `<b>The code to activate your account is ${code}</b> \n Use this link to verify account directly. <a href ="http://localhost:8000/api/v1/verify/email/w/${link}&${userID}" >Link</a>`,
        })
